...
function initCountryPanel() {
  ...
  createFigure(refugeesDiv, {className: 'refugees', title: 'Individual refugees from Ukraine recorded across Europe', stat: shortenNumFormat(regionalData['#affected+refugees']), indicator: '#affected+refugees'});
